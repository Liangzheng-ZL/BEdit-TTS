...
def get_parser():
    ...
    parser.add_argument('--is-extra-spk', default=False, type=strtobool,
                        help='The speaker ids indicate extra speakers or training speakers.')
    parser.add_argument('--use-gt-condition', default=False, type=strtobool,
                        help='Whether using ground-truth extracted conditions.')
    ##############################################
    return parser
