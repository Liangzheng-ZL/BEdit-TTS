...
def get_parser():
    ...
    ################ CPD modified ################
    parser.add_argument('--is-extra-src-spk', default=False, type=strtobool,
                        help='Whether the speaker id indicates extra speakers.')
    parser.add_argument('--is-extra-tgt-spk', default=False, type=strtobool,
                        help='Whether the speaker id indicates extra speakers.')
    parser.add_argument('--tgt-spkid', default=0, type=int,
...
def main(args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts import transfer
        transfer(args)
    else:
