...
parser.add_argument('--phn_text', type=str,  help='phoneme text')
parser.add_argument('--w2p_dict', type=str, help='word to phonemes')
parser.add_argument('--phn_duration', type=str,  help='phone duration')
# output
...
for i in range(total_utt_num):
    ...
    # len_uwp = 0
    # for wi_ in utt_words_pron:
    #     len_uwp += wi_["phoneme_length"]
    # if len_uwp == len(utt_phones):
