...
if __name__ == "__main__":
    ...
    parser.add_argument('--condition_path', type=str,
                        default='../exp/phn_train_no_eval_pytorch_train_fastspeech/outputs_model.last1.avg.best_decode/phn_train_no_eval/gt_condition')
    parser.add_argument('--idx_json_path', type=str,
                        default="../exp/phn_train_no_eval_pytorch_train_fastspeech/outputs_model.last1.avg.best_decode/phn_train_no_eval/output_info/output_info.json")
    parser.add_argument('--target_path', type=str,
                        default="../exp/phn_train_no_eval_pytorch_train_fastspeech/outputs_model.last1.avg.best_decode/phn_train_no_eval/gt_conditions_all")
